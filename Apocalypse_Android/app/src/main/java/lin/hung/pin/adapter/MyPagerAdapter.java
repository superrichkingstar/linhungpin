...
import lin.hung.pin.fragment.BookMarkFragment;
import lin.hung.pin.fragment.CatalogFragment;
...
public class MyPagerAdapter extends FragmentPagerAdapter {
    ...
    private final String[] titles = { "目錄", "書籤" };
        ...
        switch (position) {
            case 0:
                if (catalogueFragment == null) {
                    ...
                    //創建bookMarkFragment實例時同時把需要intent中的值傳入
