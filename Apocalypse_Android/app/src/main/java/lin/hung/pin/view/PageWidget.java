...
import lin.hung.pin.view.animation.AnimationProvider;
import lin.hung.pin.view.animation.CoverAnimation;
import lin.hung.pin.view.animation.NoneAnimation;
import lin.hung.pin.view.animation.SimulationAnimation;
import lin.hung.pin.view.animation.SlideAnimation;
...
public class PageWidget extends View {
    ...
    private int mScreenWidth = 0; // 屏幕寬
